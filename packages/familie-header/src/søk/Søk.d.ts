...
export declare const inputId = "sok-input";
export declare const søkKnappId = "s\u00F8k-knapp";
export declare const tømKnappId = "t\u00F8m-knapp";
export declare const Søk: {
    ({ formaterResultat, label, nullstillSøkeresultater, søk, søkeresultatOnClick, søkeresultater, ...props }: SøkProps): JSX.Element;
    displayName: string;
    __docgenInfo: {
        description: string;
        displayName: string;
