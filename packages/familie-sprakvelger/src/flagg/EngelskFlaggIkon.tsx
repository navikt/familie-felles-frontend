...
import { ariaLabelForEngelskFlagg } from './utils';

export const EngelskFlaggIkon = () => {
    const [sprak] = useSprakContext();

    return (
        <svg width={25} height={18} aria-label={ariaLabelForEngelskFlagg(sprak.locale)} role="img">
